...
public class OAuthManager {
    ...
    /**
     * In the context of demo, this is the method we care about. It configures the URL to the OAuth
     * authorisation endpoint and uses Custom Tabs to open it.
     */
    public void authorize(Context context, String scope) {
        ...
        // Without setting FLAG_ACTIVITY_NEW_TASK, the Custom Tabs is closed and the Activity
